export const Constants = {
  API_ADMIN_ENDPOINT: {
    ...
    GET_POSITION_WISE_EMPLOYEE: "getpositionwiseemployee",
    GET_GENDER_WISE_EMPLOYEE: "getgenderwiseemployee",
    ...
    GET_TICKET_STATUS_WISE: "getstatuswiseticket",
  ...
  API_EMPLOYEE_ENDPOINT: {
    ...
    GET_TICKETS_RAISED_BY_ME_DEPT_WISE: "getticketraisedbymedeptwise",
    GET_TICKETS_RAISED_BY_ME_STATUS_WISE: "getticketraisedbymestatuswise",
    GET_TICKETS_IN_MY_NAME_DEPT_WISE: "getticketinmynamedeptwise",
    GET_TICKETS_IN_MY_NAME_STATUS_WISE: "getticketinmynamestatuswise",
