        ...
        <div className="flex flex-col items-center bg-black ">
            ...
            >
                ...
                <div className="absolute top-0 left- w-full h-full">
                    ...
                    {/* <div className="absolute lg:w-96 md:w-96 w-40 lg:h-96 md:h-96 h-40 bg-blue-500 opacity-20 rounded-full filter blur-2xl lg:bottom-80 lg:right-80 "></div> */}
                </div>
            </section>
            ...
            >
                ...
                {/* <div className="absolute top-0 left- w-full h-full"> */}
                {/* <div className="absolute w-96 h-96 bg-blue-500 opacity-50 rounded-full filter blur-2xl -top-20 -left-20 z-0"></div> */}
                {/* <div className="absolute w-96 h-96 bg-purple-900 opacity-20 rounded-full filter blur-3xl -bottom-40 -left-0 z-20"></div>
        </div> */}
            </section>
