            ...
            >
              <div className="p-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white hover:bg-blue-700 font-bold py-2 px-4 rounded shadow-md text-xs lg:text-lg md:text-md ml-10 transition-transform transform hover:scale-110 duration-1000"
                >
                  {card.buttonText}
                </button>
              </div>
